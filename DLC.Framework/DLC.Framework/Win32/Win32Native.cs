...
namespace DLC.Framework.Win32
{
	internal class Win32Native
	{
		...
		internal delegate IntPtr KBDLLHookProc(int code, WindowsMessage wParam, KBDLLHOOKSTRUCT lParam);

		[DllImport("user32.dll", CharSet = CharSet.Auto, SetLastError = true)]
		internal static extern IntPtr SetWindowsHookEx(HookType hookType, HookProc lpfn, IntPtr hMod, uint dwThreadId);

		[DllImport("user32.dll", CharSet = CharSet.Auto, SetLastError = true)]
		internal static extern IntPtr SetWindowsHookEx(HookType hookType, KBDLLHookProc lpfn, IntPtr hMod, uint dwThreadId);
