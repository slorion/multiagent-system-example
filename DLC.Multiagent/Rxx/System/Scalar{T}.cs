...
namespace System
{
  ...
  public sealed class Scalar<T> : IList<T>, IObservable<T>, IEquatable<Scalar<T>>, IEquatable<T>, IStructuralEquatable
  {
    ...
    /// <summary>
    /// Synchronously invokes <see cref="IObserver{T}.OnNext"/> with <see cref="Value"/>, followed by <see cref="IObserver{T}.OnCompleted"/>.
    /// </summary>
    /// <param name="observer">The object that is to receive notifications.</param>
    /// <returns>An object that does nothing when disposed.</returns>
    ...
    {
      return object.ReferenceEquals(first, null) ? second == null : first.Equals(second);
    }
    ...
    public static bool operator ==(Scalar<T> first, T value)
    {
      ...
      return object.ReferenceEquals(first, null) ? value == null : first.comparer.Equals(first.value, value);
    }
