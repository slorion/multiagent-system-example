...
namespace System.Reactive.Linq
{
  public static partial class Observable2
  {
    ...
    /// <returns>A <see cref="ReadOnlyDictionarySubject{TKey,TValue}"/> that receives the elements from the specified sequence.</returns>
    public static ReadOnlyDictionarySubject<TKey, TValue> Collect<TKey, TValue>(this IObservable<TValue> source, Func<TValue, TKey> keySelector, IEqualityComparer<TKey> comparer)
    {
      Contract.Requires(source != null);
      Contract.Requires(keySelector != null);
    ...
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Reliability", "CA2000:Dispose objects before losing scope",
      Justification = "All disposables are composited by the subject that is returned to the caller.")]
    public static ReadOnlyDictionarySubject<TKey, TValue> Collect<TKey, TValue>(this IObservable<CollectionModification<KeyValuePair<TKey, TValue>>> source, IEqualityComparer<TKey> comparer)
    {
      Contract.Requires(source != null);
      Contract.Requires(comparer != null);
      Contract.Ensures(Contract.Result<ReadOnlyDictionarySubject<TKey, TValue>>() != null);
    ...
    public static ReadOnlyDictionarySubject<TKey, TValue> Collect<TKey, TValue>(
      ...
      IObservable<CollectionModification<KeyValuePair<TKey, TValue>>> changes)
    {
      ...
      return Collect(existing, keySelector, changes, EqualityComparer<TKey>.Default);
    }
      ...
      IEqualityComparer<TKey> comparer)
    {
      ...
      return Collect(existing.ToObservable(PlatformSchedulers.Concurrent), keySelector, changes, comparer);
    }
      ...
      IEqualityComparer<TKey> comparer)
    {
      ...
      return Collect(existing, keySelector, changes, all => all.SelectMany(n => n.ToModifications()), comparer);
    }
      ...
      Func<IObservable<CollectionNotification<KeyValuePair<TKey, TSource>>>, IObservable<CollectionModification<KeyValuePair<TKey, TResult>>>> selector)
    {
      ...
      return Collect(existing, keySelector, changes, selector, EqualityComparer<TKey>.Default);
    }
      ...
      IEqualityComparer<TKey> comparer)
    {
      ...
      return Collect(existing.ToObservable(PlatformSchedulers.Concurrent), keySelector, changes, selector, comparer);
    }
