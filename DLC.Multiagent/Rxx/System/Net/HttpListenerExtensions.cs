...
namespace System.Net
{
  ...
  public static class HttpListenerExtensions
  {
      ...
      string subProtocol)
    {
      ...
      return StartObservableWebSockets(listener, subProtocol, Observable2.DefaultMaxConcurrent);
    }
      ...
      TimeSpan keepAliveInterval)
    {
      ...
      return StartObservableWebSockets(listener, subProtocol, receiveBufferSize, keepAliveInterval, Observable2.DefaultMaxConcurrent);
    }
