...
namespace System.Net
{
  ...
  public static class ObservableHttpListener
  {
      ...
      string subProtocol)
    {
      ...
      return StartWebSockets(domain, port, path, subProtocol, Observable2.DefaultMaxConcurrent);
    }
      ...
      TimeSpan keepAliveInterval)
    {
      ...
      return StartWebSockets(domain, port, path, subProtocol, receiveBufferSize, keepAliveInterval, Observable2.DefaultMaxConcurrent);
    }
